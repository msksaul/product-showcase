...
import { SparklesIcon, ArrowRightIcon, RocketIcon, UserIcon, EyeIcon } from 'lucide-react'
...
const LiveBadge = () => {
  return (
    <Badge variant={'outline'} className='px-4 py-4 mb-8 text-sm backdrop-blur-sm'>
      ...
      <div className='wrapper'>
        <div className='flex flex-col items-center justify-center lg:py-24 py-12 text-center'>
          ...
          <div className='flex flex-col sm:flex-row gap-4 mb-16'>
            ...
            <Button asChild variant={'secondary'} size={'lg'} className='text-base px-8 shadow-lg'>
              <Link href={'/explore'}>
                Explore Projects
